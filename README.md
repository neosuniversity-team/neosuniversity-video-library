## El objetivo de la práctica es tener un Login utilizando Bootstrap + FontAwesome 5


Agregar las carpetas siguientes carpetas en la ruta src/main/resources

 - css
 - image
 - webfonts
 
En la carpeta src/main/resources/css genere un archivo llamado login.css con el siguiente contenido
...
### Descarga Fontawesome 5

Accede al link para poder ingresar a la descarga de fontawesome

https://fontawesome.com/how-to-use/on-the-web/setup/hosting-font-awesome-yourself

 - Busca el Link "Download Font Awesome Free for the Web"
