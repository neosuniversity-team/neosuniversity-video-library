...
### Restricción de paginas de acuerdo al rol del usuario
...
Ahora utilice los conceptos aprendidos para modificar las vistas de acuerdo al rol que esta logueado en el sistema
En el caso de que un usuario que no tenga el rol ADMIN debe desaparecer el botón Agregar Nueva Película

Modifique el pom.xml para agregar la dependencia tag lib de spring security
...
Modifique la JSP listPeliculas.jsp para poder agregar la librería de etiquetas y agregar la funcionalidad para poder ocultar el botón en caso de que el usuario
logueado no tenga el rol ROLE_ADMIN
...
El código completo de la página listPeliculas.jsp es: 
...
Pruebe la nueva funcionalidad, utilizando el usuario user/user y verifique que el botón Agregar Nueva Película no aparece en la página.
